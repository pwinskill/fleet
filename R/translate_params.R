...
# keyed the SAME way round as that table -- White/equilibrium name on the left,
# malariasimulation name on the right -- so the two can be diffed line by line.
# That is the opposite direction from .back_translations above, because the
# vivax map is ADDITIVE rather than a rename: the vivax equilibrium reads some
# fields under their malariasimulation names (sigma_squared,
# n_heterogeneity_groups) and others under White's, from the same list.
# Renaming would break the first kind.
#
