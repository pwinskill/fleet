...
differences in acquired immunity and disease-pool composition between the mean
field and the IBM, so severe incidence — and the DALYs derived from it — can
differ by more than prevalence or clinical incidence does, largest at low EIR.
