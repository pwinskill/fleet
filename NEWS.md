...
* **All four workflows are live**, so something now checks the model without
  ...
  that never shows up in a commit here. `.github/workflows/CI.md` is now a description of
...
* **CI for the comparison.** Two new workflows, `comparison.yaml` (the drift
  ...
  them on: all four workflows are live now, as `.github/workflows/CI.md` describes. Read
