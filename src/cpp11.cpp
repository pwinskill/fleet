...
extern "C" SEXP _blink_dust2_system_malaria_ode_alloc(SEXP r_pars, SEXP r_time, SEXP r_time_control, SEXP r_n_particles, SEXP r_n_groups, SEXP r_seed, SEXP r_deterministic, SEXP r_n_threads) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_internals(SEXP ptr, SEXP include_coefficients, SEXP include_history) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_run_to_time(SEXP ptr, SEXP r_time) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_state(SEXP ptr, SEXP r_index_state, SEXP r_index_particle, SEXP r_index_group, SEXP preserve_particle_dimension, SEXP preserve_group_dimension) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_time(SEXP ptr) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_set_state_initial(SEXP ptr) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_set_state(SEXP ptr, SEXP r_state) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_reorder(SEXP ptr, SEXP r_index) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_rng_state(SEXP ptr) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_set_rng_state(SEXP ptr, SEXP r_rng_state) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_set_time(SEXP ptr, SEXP r_time) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_update_pars(SEXP ptr, SEXP pars) {
  BEGIN_CPP11
...
extern "C" SEXP _blink_dust2_system_malaria_ode_simulate(SEXP ptr, SEXP r_times, SEXP r_index_state, SEXP preserve_particle_dimension, SEXP preserve_group_dimension) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_blink_dust2_system_malaria_ode_alloc",             (DL_FUNC) &_blink_dust2_system_malaria_ode_alloc,             8},
    {"_blink_dust2_system_malaria_ode_internals",         (DL_FUNC) &_blink_dust2_system_malaria_ode_internals,         3},
    {"_blink_dust2_system_malaria_ode_reorder",           (DL_FUNC) &_blink_dust2_system_malaria_ode_reorder,           2},
    {"_blink_dust2_system_malaria_ode_rng_state",         (DL_FUNC) &_blink_dust2_system_malaria_ode_rng_state,         1},
    {"_blink_dust2_system_malaria_ode_run_to_time",       (DL_FUNC) &_blink_dust2_system_malaria_ode_run_to_time,       2},
    {"_blink_dust2_system_malaria_ode_set_rng_state",     (DL_FUNC) &_blink_dust2_system_malaria_ode_set_rng_state,     2},
    {"_blink_dust2_system_malaria_ode_set_state",         (DL_FUNC) &_blink_dust2_system_malaria_ode_set_state,         2},
    {"_blink_dust2_system_malaria_ode_set_state_initial", (DL_FUNC) &_blink_dust2_system_malaria_ode_set_state_initial, 1},
    {"_blink_dust2_system_malaria_ode_set_time",          (DL_FUNC) &_blink_dust2_system_malaria_ode_set_time,          2},
    {"_blink_dust2_system_malaria_ode_simulate",          (DL_FUNC) &_blink_dust2_system_malaria_ode_simulate,          5},
    {"_blink_dust2_system_malaria_ode_state",             (DL_FUNC) &_blink_dust2_system_malaria_ode_state,             6},
    {"_blink_dust2_system_malaria_ode_time",              (DL_FUNC) &_blink_dust2_system_malaria_ode_time,              1},
    {"_blink_dust2_system_malaria_ode_update_pars",       (DL_FUNC) &_blink_dust2_system_malaria_ode_update_pars,       2},
    {NULL, NULL, 0}
};
}

extern "C" attribute_visible void R_init_blink(DllInfo* dll){
