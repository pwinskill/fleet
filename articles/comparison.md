...
bars against blink triangles. Top left: LM parasite prevalence in 2-10
...
from 0.21 to only 0.81 and flattening much earlier, with blink a shade
...
falls back by EIR 120, with blink running just below the IBM over the
plateau.](cmp_core_eir.png)

Across the 120-fold range the prevalence and under-5 clinical curves lie
on top of each other. The largest gap in PfPR_(2–10) between blink and
the IBM median is 0.004 (0.237 against 0.240 at EIR 3), and blink sits
...
year and blink’s reported `EIR` are within about 1% of the target
...
So the small excess blink carries in under-5s is more than repaid at
...
years, IBM dashed coral against blink solid indigo, the two almost
...
915 scenario-months in each panel column, `blink` sits inside the IBM’s
10–90% replicate band in **83%** of them for prevalence, 84% for both
clinical measures and 78% for severe incidence – and since an 80% band
...
*15-year mean reduction against the no-intervention row, IBM / blink.*
...
SMC and case management do not reduce transmission much at all – SMC
cuts under-5 clinical incidence in half but all-age clinical incidence
by only about a fifth, because it protects a narrow age band, and case
